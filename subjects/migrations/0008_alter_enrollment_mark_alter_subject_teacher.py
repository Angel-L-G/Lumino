...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('subjects', '0007_alter_enrollment_mark'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='subject',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='teaching_subjects', to=settings.AUTH_USER_MODEL),
        ),
    ]
